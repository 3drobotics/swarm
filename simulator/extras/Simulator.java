...
public class Simulator implements Runnable {
    ...
    public static boolean   USE_GIMBAL            = false;   // enable gimbal modeling (optionally also define remote pitch/roll controls below)
    ...
    public static boolean   GUI_ENABLE_AA         = false;   // anti-alias on 3D scene
    ...
    public static boolean   LOG_TO_STDOUT         = false;   // send System.out messages to stdout (console) as well as any custom handlers (see SystemOutHandler)
    
    public static final int    DEFAULT_SIM_SPEED = 200; // Hz
